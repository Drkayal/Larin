...
@pyrogram_manager.on_message(filters.command("youtube_stats", prefixes=["/", "!"]))
async def youtube_api_stats_handler(client: Client, message: Message):
...
@pyrogram_manager.on_message(filters.command("test_youtube_api", prefixes=["/", "!"]))
async def test_youtube_api_handler(client: Client, message: Message):
